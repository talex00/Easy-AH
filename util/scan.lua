...
function M.find(auction_record, status_bar, on_abort, on_failure, on_success)
    ...
    if auction_record.blizzard_query then
        local blizzard_query1 = EasyAH.copy(auction_record.blizzard_query)
        ...
        if auction_record.page > 0 then
            local blizzard_query2 = EasyAH.copy(auction_record.blizzard_query)
        ...
        if not EasyAH.eq(auction_record.blizzard_query, item_query.blizzard_query) then
