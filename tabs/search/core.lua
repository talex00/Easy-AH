...
local tab = EasyAH.tab 'Search'

StaticPopupDialogs.EASYAH_SEARCH_TABLE_FULL = {
...
RESULTS, SAVED, FILTER = EasyAH.enum(3)
...
function add_filter(filter_string)
    ...
    old_filter_string = EasyAH.trim(old_filter_string)
