...
frame.content:SetPoint('BOTTOMLEFT', EasyAH.frame.content, 'BOTTOMLEFT', 0, 0)
frame.content:SetPoint('BOTTOMRIGHT', EasyAH.frame.content, 'BOTTOMRIGHT', 0, 0)
...
do
    ...
    btn:SetScript('OnClick', post_all)
    post_all_button = btn
end
do
...
do
	...
	btn:Hide()
	similar_items_button = btn
end

function EasyAH.handle.LOAD()
	if not EasyAH.account_data.post_bid then
